...
import org.huwtl.penfold.domain.model.{Version, Id, JobType, Payload}
import org.huwtl.penfold.domain.event.JobCreated
import org.joda.time.DateTime

class EventSerializerTest extends Specification {
  val event = JobCreated(Id("a1"), Version.init, JobType("abc"), new DateTime(2014, 2, 3, 12, 47, 54), new DateTime(2014, 2, 3, 14, 30, 1), Payload(Map("stuff" -> "something", "nested" -> Map("inner" -> true))))
