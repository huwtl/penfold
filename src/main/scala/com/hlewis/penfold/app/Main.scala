package com.hlewis.penfold.app

import javax.servlet.ServletContext
import org.scalatra.LifeCycle
import com.hlewis.penfold.app.support._
import com.hlewis.penfold.app.web._
import com.hlewis.penfold.app.store.{DbInMemoryJobStore, InMemoryJobStore}
import java.net.URI
import com.hlewis.penfold.app.support.hal.{HalTriggeredJobFeedFormatter, HalStartedJobFormatter, HalJobFormatter, HalCompletedJobFormatter}
import com.hlewis.penfold.usecases._
import java.util.concurrent.Executors._
import java.util.concurrent.TimeUnit._
import com.googlecode.flyway.core.Flyway
import com.mchange.v2.c3p0.ComboPooledDataSource
import scala.slick.session.Database
import com.hlewis.penfold.domain.{Payload, Status, Job}
