...
import org.huwtl.penfold.query.{EventRecord, EventSequenceId, EventStoreQueryService}
...
class JdbcEventStoreQueryService(database: Database, serializer: EventSerializer) extends EventStoreQueryService {
