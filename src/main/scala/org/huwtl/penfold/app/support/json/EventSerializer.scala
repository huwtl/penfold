...
class EventSerializer {
  ...
  implicit val formats = new Formats {
    ...
    override val typeHints = ShortTypeHints(classOf[TaskCreated] :: classOf[FutureTaskCreated] :: classOf[TaskPayloadUpdated] :: classOf[TaskTriggered] :: classOf[TaskStarted] :: classOf[TaskRequeued] :: classOf[TaskCompleted] :: classOf[TaskCancelled] :: classOf[TaskArchived] :: Nil)
